Public Class questao7
    ...
    Private Sub questão_7_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Timer1.Start()
        PictureBox1.Image = My.Resources.questao7
